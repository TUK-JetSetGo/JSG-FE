...
import com.tuk.jetsetgo.util.network.onError
import com.tuk.jetsetgo.util.network.onException
import com.tuk.jetsetgo.util.network.onFail
import com.tuk.jetsetgo.util.network.onSuccess
